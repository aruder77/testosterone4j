...
public class IntegerDTEquivalenceClassTest {
    ...
    public void testMinusMinus() {
        ...
        IntegerDTEquivalenceClass clazz2 = IntegerDTEquivalenceClass.getByValue(-1500);
        assertEquals(IntegerDTEquivalenceClass.minusMinus, clazz2);
        IntegerDTEquivalenceClass clazz3 = IntegerDTEquivalenceClass.getByValue(-100);
    ...
    public void testMinus() {
        ...
        IntegerDTEquivalenceClass clazz2 = IntegerDTEquivalenceClass.getByValue(-50);
        assertEquals(IntegerDTEquivalenceClass.minus, clazz2);
        IntegerDTEquivalenceClass clazz3 = IntegerDTEquivalenceClass.getByValue(-2);
    ...
    public void testSmall() {
        ...
        IntegerDTEquivalenceClass clazz3 = IntegerDTEquivalenceClass.getByValue(99);
