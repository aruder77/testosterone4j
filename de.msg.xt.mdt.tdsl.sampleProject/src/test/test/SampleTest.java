...
public class SampleTest {
    ...
    public static List<SampleUseCase> generate() {
    	...
    	List<SampleUseCase> testCases = generator.generate();
    	
    	// generate the test cases
//    	testCases.add(new SampleUseCase(new StringDT("a", StringDTEquivalenceClass.shortString), new Sachnummer("b", SachnummerEquivalenceClass.snrString), new SampleSubUseCase(new StringDT("c", StringDTEquivalenceClass.shortString))));
//    	testCases.add(new SampleUseCase(new StringDT("abaclkavjsödlfkjasödfljkasö", StringDTEquivalenceClass.longString), new Sachnummer("b", SachnummerEquivalenceClass.snrString), new SampleSubUseCase(new StringDT("c", StringDTEquivalenceClass.shortString))));
