...
public enum TerminationDTEquivalenceClass implements EquivalenceClass {
  wert;
      ...
      case wert:
        Iterable<String> wertIterable = new Function0<Iterable<String>>() {
          public Iterable<String> apply() {
            ArrayList<String> _newArrayList = CollectionLiterals.<String>newArrayList("HEX_FF", "LENGTH", "NONE", "ZERO");
  ...
  public static TerminationDTEquivalenceClass getByValue(final String value) {
    bne3.datatypes.TerminationDTEquivalenceClass clazz = null;
    if (value != null) {
      Iterable<String> wertIterable = new Function0<Iterable<String>>() {
        public Iterable<String> apply() {
          ArrayList<String> _newArrayList = CollectionLiterals.<String>newArrayList("HEX_FF", "LENGTH", "NONE", "ZERO");
