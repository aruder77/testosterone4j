...
import bne3.activities.datatypetype.AufzaehlungstypenCodingTypeSearchAdapter;
...
public class AufzaehlungstypenCodingTypeSearch extends DialogActivity {
  private final static String ID = "bne3.activities.datatypetype.AufzaehlungstypenCodingTypeSearch";
  ...
  private AufzaehlungstypenCodingTypeSearchAdapter contextAdapter;
  
  public static AufzaehlungstypenCodingTypeSearch find() {
    return new AufzaehlungstypenCodingTypeSearch(activityLocator.find(ID, AufzaehlungstypenCodingTypeSearchAdapter.class));
  }
  
  public AufzaehlungstypenCodingTypeSearch() {
    super();
  }
  
  public AufzaehlungstypenCodingTypeSearch(final AufzaehlungstypenCodingTypeSearchAdapter contextAdapter) {
  ...
  public AufzaehlungstypenCodingTypeSearch searchText_setText(final StringDT str) {
  ...
  public AufzaehlungstypenCodingTypeSearch searchButton_push() {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_invokeContextMenu(final StringDT contextMenuEntry) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_invokeContextMenuOnRow(final IntegerDT row, final StringDT contextMenuEntry) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_isContextMenuEnabled(final StringDT contextMenuEntry) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_setText(final IntegerDT row, final IntegerDT column, final StringDT textValue) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_setTextByName(final IntegerDT row, final StringDT columnName, final StringDT textValue) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_selectValue(final IntegerDT row, final IntegerDT column, final StringDT textValue) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_selectValueByName(final IntegerDT row, final StringDT columnName, final StringDT textValue) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_checkRow(final IntegerDT row) {
  ...
  public AufzaehlungstypenCodingTypeSearch elements_selectRow(final IntegerDT row) {
  ...
  public AufzaehlungstypenEditor cancelButton_push() {
    ...
    return AufzaehlungstypenEditor.find();
  }
  ...
  public AufzaehlungstypenEditor okButton_push() {
