...
import bne3.usecases.paket.CreatePaket;
...
public class CreatePaketTest {
  private final static String TEST_CASES_SERIALIZATION = "./CREATEPAKETTEST_1369638543096";
  ...
  private final CreatePaket useCase;
  ...
  public static Collection<Object[]> config() {
    ...
    LOCATOR.beforeTest();
    return testHelper.readOrGenerateTestCases(TEST_CASES_SERIALIZATION, generator, CreatePaket.class);
  }
  
  public CreatePaketTest(final TestDescriptor<CreatePaket> testDescriptor) {
