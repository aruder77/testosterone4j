...
import bne3.usecases.datatypetype.CreateBasisdatentyp;
...
public class CreateBasisdatentypTest {
  private final static String TEST_CASES_SERIALIZATION = "./CREATEBASISDATENTYPTEST_1369638542692";
  ...
  private final CreateBasisdatentyp useCase;
  ...
  public static Collection<Object[]> config() {
    ...
    LOCATOR.beforeTest();
    return testHelper.readOrGenerateTestCases(TEST_CASES_SERIALIZATION, generator, CreateBasisdatentyp.class);
  }
  
  public CreateBasisdatentypTest(final TestDescriptor<CreateBasisdatentyp> testDescriptor) {
