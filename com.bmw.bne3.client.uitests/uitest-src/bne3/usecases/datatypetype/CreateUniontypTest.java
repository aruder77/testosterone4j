...
import bne3.usecases.datatypetype.CreateUniontyp;
...
public class CreateUniontypTest {
  private final static String TEST_CASES_SERIALIZATION = "./CREATEUNIONTYPTEST_1369638542708";
  ...
  private final CreateUniontyp useCase;
  ...
  public static Collection<Object[]> config() {
    ...
    LOCATOR.beforeTest();
    return testHelper.readOrGenerateTestCases(TEST_CASES_SERIALIZATION, generator, CreateUniontyp.class);
  }
  
  public CreateUniontypTest(final TestDescriptor<CreateUniontyp> testDescriptor) {
