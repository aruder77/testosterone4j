...
import bne3.usecases.datatypetype.CreateAufzaehlungstyp;
...
public class CreateAufzaehlungstypTest {
  private final static String TEST_CASES_SERIALIZATION = "./CREATEAUFZAEHLUNGSTYPTEST_1369638542700";
  ...
  private final CreateAufzaehlungstyp useCase;
  ...
  public static Collection<Object[]> config() {
    ...
    LOCATOR.beforeTest();
    return testHelper.readOrGenerateTestCases(TEST_CASES_SERIALIZATION, generator, CreateAufzaehlungstyp.class);
  }
  
  public CreateAufzaehlungstypTest(final TestDescriptor<CreateAufzaehlungstyp> testDescriptor) {
